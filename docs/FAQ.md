...
> 📌 相关 Issue: [#153](https://github.com/DesayGo/daily_stock_analysis/issues/153)
...
> 📌 相关 Issue: [#155](https://github.com/DesayGo/daily_stock_analysis/issues/155)
...
> 📌 相关 Issue: [#372](https://github.com/DesayGo/daily_stock_analysis/issues/372)
...
**怎么查当前 Docker 版本**：
1. **先看部署命令或 Compose 文件里的镜像 tag**：例如 `ghcr.io/<GHCR_NAMESPACE>/daily_stock_analysis:v3.12.0`，其中 `v3.12.0` 就是当前部署版本。
2. **如果你拉的是 `latest`**：请回看当时的 `docker pull` / `docker-compose.yml` / 部署脚本，或对照 [GitHub Releases](https://github.com/DesayGo/daily_stock_analysis/releases) 确认对应发布记录。
...
2. 搜索或提交 [GitHub Issue](https://github.com/DesayGo/daily_stock_analysis/issues)
