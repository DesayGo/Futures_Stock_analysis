...
> Related Issue: [#153](https://github.com/DesayGo/daily_stock_analysis/issues/153)
...
> Related Issue: [#155](https://github.com/DesayGo/daily_stock_analysis/issues/155)
...
1. **Check the image tag in your deploy command or Compose file**. For example, in `ghcr.io/<GHCR_NAMESPACE>/daily_stock_analysis:v3.12.0`, the deployed version is `v3.12.0`.
2. **If you used `latest`**, check your original `docker pull`, `docker-compose.yml`, or deployment script, then compare with [GitHub Releases](https://github.com/DesayGo/daily_stock_analysis/releases).
...
2. Search or submit [GitHub Issue](https://github.com/DesayGo/daily_stock_analysis/issues)
